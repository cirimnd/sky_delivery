...
//                orderVO.setOrderDetailList(detailList);
    ...
    public OrderStatisticsVO statistics() {
        int confirmed= orderMapper.getByStatus(Orders.CONFIRMED);
        int deliveryInProgress= orderMapper.getByStatus(Orders.DELIVERY_IN_PROGRESS);
        int toBeConfirmed= orderMapper.getByStatus(Orders.TO_BE_CONFIRMED);
